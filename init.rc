...
# parameters to match how it is managing things.
	...
	write /sys/module/lowmemorykiller/parameters/minfree 13168,15022,16876,18924,20776,22630
...
# Projector Factory
    chown system radio /sys/class/sec/sec_projector/proj_key
    chown system radio /sys/class/sec/sec_projector/projection_verify
    chown system radio /sys/class/sec/sec_projector/motor_verify
    chown system radio /sys/class/sec/sec_projector/retval  
    chown system radio /sys/class/sec/sec_projector/proj_motor
    chown system radio /sys/class/sec/sec_projector/brightness
    chown system radio /sys/class/sec/sec_projector/cal_history
    chown system radio /sys/class/sec/sec_projector/rotate_screen
    chown system radio /sys/class/sec/sec_projector/screen_direction    
