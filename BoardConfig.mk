...
# -include vendor/samsung/GT-I8530/BoardConfigVendor.mk

# Default values, if not overridden else where.
# TARGET_BOARD_INFO_FILE ?= device/samsung/tuna/board-info.txt
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR ?= device/samsung/GT-I8530/bluetooth
...
TARGET_PREBUILT_KERNEL := device/samsung/GT-I8530/kernel.bin
TARGET_PREBUILT_KERNEL := device/samsung/GT-I8530/kernel2.bin
...
TARGET_RECOVERY_FSTAB = device/samsung/tuna/fstab.samsunggavini
